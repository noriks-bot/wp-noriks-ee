...
get_header(); ?>
  ...
  <div class="hero__media" aria-hidden="true">
    ...
    <img
      src="/ee/wp-content/themes/noriks/img/noriks-hero.jpeg"
      alt=""
    />
  </div>
...
@media (max-width: 640px) {
  ...
  <div class="collections__header">
    <h2 class="collections__title">Osta kollektsioonide kaupa</h2>

    <a class="collections__cta" href="/ee/shop">
      Kõik tooted <span aria-hidden="true">›</span>
    </a>
  </div>

  <div class="collections__grid">
    <!-- Card 1 -->
    <a class="collection-card" href="/ee/shop/?filter_product_cat=t-shirts">
      <div class="collection-card__media">
        <img
          src="/ee/wp-content/themes/noriks/img/noriks-majice.jpeg"
      ...
      <div class="collection-card__body">
        <div class="collection-card__text">
          <div class="collection-card__topline">
            <h3 class="collection-card__name">T-särgid</h3>
          </div>
          <p class="collection-card__desc">
Mugavus terve päeva. Ei venita.
          </p>
        </div>
    ...
    <!-- Card 2 -->
    <a class="collection-card" href="/ee/shop/?filter_product_cat=boxers">
      <div class="collection-card__media">
        <img
          src="/ee/wp-content/themes/noriks/img/noriks-boksarice.jpeg"
          alt="V-neck t-shirt"
        />
      </div>
      ...
      <div class="collection-card__body">
        <div class="collection-card__text">
          <div class="collection-card__topline">
            <h3 class="collection-card__name">Bokserid</h3>
          </div>
          <p class="collection-card__desc">
   Pehmed. Hingavad. Usaldusväärsed.
    ...
    <!-- Card 3 -->
    <a class="collection-card" href="/ee/product-category/bundles/">
      <div class="collection-card__media">
        <img
          src="/ee/wp-content/themes/noriks/img/noriks-kompleti.jpeg"
      ...
      <div class="collection-card__body">
        <div class="collection-card__text">
          <div class="collection-card__topline">
            <h3 class="collection-card__name">Komplektid</h3>
       
          </div>
          <p class="collection-card__desc">
Parim hinna ja kvaliteedi suhe komplektis.
          </p>
        </div>
    ...
    <!-- Card 4 - Starter Pack -->
    <a class="collection-card" href="/ee/shop/?filter_product_cat=starter-pack">
      <div class="collection-card__media">
        <img
          src="/ee/wp-content/themes/noriks/img/starter-paket_.jpeg"
          alt="Long sleeve shirt"
        />
      </div>
      ...
      <div class="collection-card__body">
        <div class="collection-card__text">
          <div class="collection-card__topline">
            <h3 class="collection-card__name">Stardikomplekt</h3>
           
           
          </div>
          <p class="collection-card__desc">
Proovi NORIKS soodsamalt.
