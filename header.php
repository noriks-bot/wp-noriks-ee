        ...
        <?php foreach ($header_nav as $item): ?>
            ...
            <?php if ($i === 0): ?>
                ...
                <div class="nav-item has-dropdown">
                    ...
                    <div class="dropdown-menu">
                        <a href="/ee/shop">Loo oma komplekt</a>
                        <a href="/ee/product-category/tricka/">Valmis komplektid</a>
                    </div>
                    -->
                </div>
            ...
            <?php elseif ($i === 1): ?>
                ...
                <div class="nav-item has-dropdown">
                    ...
                    <!--
                    <div class="dropdown-menu">
                        <a href="/ee/product-category/boxerky-sastavi-paket/">Loo oma komplekt</a>
                        <a href="/ee/product-category/boxerky/">Valmis komplektid</a>
                    </div>
                    -->
                </div>
    ...
    <div class="navbar-right">
      ...
      <div class="cart-auto-icon">
        ...
        <?php if ( class_exists( 'WooCommerce' ) ) : ?>
            <a class="header-cart" href="/ee/cart">
                <div class="cart-icon">
