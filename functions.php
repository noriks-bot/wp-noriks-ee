...
add_action('init', function () {
	...
	add_filter('woocommerce_add_to_cart_redirect', function ($url) {
		return home_url('/ee/cart/'); // or wc_get_cart_url()
	}, 9999);
});
...
} else if ($webshop_language == "EE") {
  include(get_template_directory() . '/functions/lang/ee.php');
}
// Default to Estonian for this store
include(get_template_directory() . '/functions/lang/ee.php');
/*  include language specific files */
